...
void AgendaPOS() {
  ...
  for (int i = 0; i < registros3; i++) {
    ...
    pos[i] = linha.substring(linha.indexOf('-') + 1, linha.indexOf('/')).toInt();
    percA[i] = linha.substring(linha.indexOf('/') + 1, linha.indexOf('\n')).toInt();
  }
}
...
void AgendaPOS2() {
  ...
  for (int i = 0; i < registros3; i++) {
    ...
    percA2[i] = linha.substring(linha.indexOf('/') + 1, linha.indexOf('\n')).toInt();
  }
}
